...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
  <div class="flex items-center justify-between mb-6">
    ...
    <a href="{{ route('writer.dashboard') }}" class="text-sm text-slate-600 hover:underline">← Kembali</a>
  </div>

  <form method="POST" action="{{ route('writer.posts.update', $post) }}" enctype="multipart/form-data"
    ...
    <div>
      ...
      @endif
      <input type="file" name="thumbnail" class="mt-2 block w-full">
